...
This is the **Heard** frontend — a Next.js 16 web interface for the Heard civic empowerment platform (Claude × Penn AI Hackathon 2026, First Place, Democratic Governance track). It communicates with a LangGraph-based backend to provide thread-based AI conversations with streaming responses, artifacts, a civic map, grievance feed, and a candidate dashboard.

**Stack**: Next.js 16, React 19, TypeScript 5.8, Tailwind CSS 4, pnpm 10.26.2, better-auth, MapLibre GL.
