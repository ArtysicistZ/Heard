...
export interface Translations {
  ...
  civicMap: {
    ...
    categories: {
      cityGovernment: string;
      cityCouncil: string;
      usCongress: string;
      paStateSenate: string;
      paStateHouse: string;
      education: string;
      police: string;
      community: string;
    ...
    contacts: string;
    contactsThisMonth: string;
    totalContacts: string;
    resolutionRate: string;
    problemSolvedRate: string;
    topIssues: string;
    ...
    resolutionReported: string;
    howResolved: string;
    institution: string;
    legend: string;
    fewContacts: string;
    manyContacts: string;
    nearYou: (count: number) => string;
    noInstitutions: string;
    issueCategories: {
      abandonedVehicles: string;
      illegalDumping: string;
