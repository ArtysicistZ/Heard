  ...
  return (
    ...
    >
      <div className="flex items-center gap-6">
        <a
          href={homeURL ?? "https://github.com/StevenWang-CY/Heard"}
          target={isExternalHome ? "_blank" : "_self"}
          rel={isExternalHome ? "noopener noreferrer" : undefined}
        >
          <h1 className="font-serif text-xl">Heard</h1>
        </a>
      </div>
      ...
      <div className="relative">
        ...
        >
          <a
            href="https://github.com/StevenWang-CY/Heard"
            target="_blank"
...
async function StarCounter() {
  ...
  try {
    const response = await fetch(
      "https://api.github.com/repos/StevenWang-CY/Heard",
      {
