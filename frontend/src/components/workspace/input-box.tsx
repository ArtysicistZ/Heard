...
import { useVoiceRecorder } from "@/core/voice";
...
export function InputBox({
  ...
  const { isRecording, isProcessing: isTranscribing, error: voiceError, startRecording, stopRecording } =
    useVoiceRecorder({
      ...
      >
        ...
        <PromptInputFooter className="flex">
          ...
          <PromptInputActionMenu>
            ...
            <Tooltip content={isRecording ? "Stop recording" : isTranscribing ? "Transcribing..." : "Voice input"}>
              <PromptInputButton
                className={cn(
